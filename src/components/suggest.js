...
class Suggest{
    ...
    constructor({
        ...
        // 데이터를 바인딩한다.
        this._data = this._getSearchData().then(res => {
     ...
     */
    _show(){
        domUtil.prop(this._component, '@display', 'block');
    }
     ...
     */
    _hide(){
        domUtil.prop(this._component, '@display', 'none');
    }
    ...
    _getFirstListElement(){
        ...
        return domUtil.sels('li', this._component)[0];
    }
    ...
    _getLastListElement(){
        ...
        const elems = domUtil.sels('li', this._component);
